...
void setup()
{
    ...
    pinMode(P_LEFT, INPUT_PULLUP);     //left
    pinMode(P_UP, INPUT_PULLUP);       //up
    pinMode(P_RIGHT, INPUT_PULLUP);    //right
    pinMode(P_DOWN, INPUT_PULLUP);     //down
    pinMode(P_ZOOM_IN, INPUT_PULLUP);  //zoom in
    pinMode(P_ZOOM_OUT, INPUT_PULLUP); //zoom out
